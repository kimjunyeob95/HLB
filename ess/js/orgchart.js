...
(OrgChart.prototype.load = function (t) {
    ...
    (OrgChart.prototype._draw = function (t, m, O, y) {
        ...
        this.server.read(
            ...
            O,
            function (t) {
                m != OrgChart.action.exporting && ((x.nodes = t.nodes), (x.visibleNodeIds = t.visibleNodeIds), (x.roots = t.roots)), (x.editUI.fields = t.allFields);
                var e = { defs: '' };
                OrgChart.events.publish('renderdefs', [x, e]);
                var r = x.ui.defs(e.defs),
                    i = x.getScale(t.viewBox);
                r += x.ui.pointer(x.config, m, i);
                var a = x.getViewBox(),
                    n = t.viewBox;
                e = { content: r, res: t };
                ...
                for (var o = 0; o < t.visibleNodeIds.length; o++) {
                    var l = t.nodes[t.visibleNodeIds[o]],
                        s = x._get(l.id);
                    r += x.ui.node(l, s, t.animations, x.config, void 0, void 0, void 0, m, i, x);
                }
                for (o = 0; o < t.visibleNodeIds.length; o++) {
                    (l = t.nodes[t.visibleNodeIds[o]]), (s = x._get(l.id));
                    (r += x.ui.link(l, x, i, t.bordersByRootIdAndLevel, t.nodes)), (r += x.ui.expandCollapseBtn(x, l, x._layoutConfigs, m, i));
                }
                e = { content: r, res: t };
                if ((OrgChart.events.publish('render', [x, e]), (r = e.content), (r += x.ui.lonely(x.config)), m !== OrgChart.action.exporting)) {
                    (m !== OrgChart.action.centerNode && m !== OrgChart.action.insert && m !== OrgChart.action.expand && m !== OrgChart.action.collapse && m !== OrgChart.action.update) || (n = a),
                        m === OrgChart.action.init && null != a && (n = a),
                        (x.response = t);
                    C = x.ui.svg(x.width(), x.height(), n, x.config, r);
                    if (x._initialized) {
                        var h = x.getSvg(),
                            d = h.parentNode;
                        d.removeChild(h),
                        ...
                        (x.element.innerHTML = x.ui.css() + x.ui.exportMenuButton(x.config) + C),
                    ...
                    m === OrgChart.action.centerNode
                        ? OrgChart.anim(
                              ...
                              x.config.anim.func,
                              function () {
                                  x.ripple(O.options.rippleId), c || (y && y(), OrgChart.events.publish('redraw', [x]), x._showAfterAnimation(), (c = !0));
                              },
                              function () {
                        ...
                        : !a ||
                          ...
                          (m !== OrgChart.action.insert && m !== OrgChart.action.expand && m !== OrgChart.action.collapse && m !== OrgChart.action.update && m !== OrgChart.action.init)
                        ? 0 == g[0].length && (c || (y && y(), OrgChart.events.publish('redraw', [x]), (c = !0)))
                    ...
                    var p = t.boundary,
                        f = p.maxX - p.minX,
                        u = p.maxY - p.minY,
                        C = x.ui.svg(f, u, [p.minX, p.minY, f, u], x.config, r, i);
                    y(C);
                }
            },
            function (t) {
        ...
        if (null != i) {
            ...
            if (null != a) {
                ...
                var h = i.w,
                    ...
                    O = OrgChart.randomId();
                u.setAttribute('id', O);
                var y = { ripple: OrgChart.t(i.templateName, i.min, this.getScale()).ripple, node: i };
                OrgChart.events.publish('ripple', [this, y]),
    ...
    (OrgChart.prototype.stateToUrl = function () {
        if (this.server.state) {
            ...
            return (
                ...
                (t.adjustify = this.server.state.adjustify.x + '*' + this.server.state.adjustify.y),
    ...
    (OrgChart.prototype.generateId = function () {
        for (;;) {
            ...
            if (!this.nodes.hasOwnProperty(t)) return (this.nodes[t] = !0), t;
        }
    }),
    ...
    (OrgChart.prototype.remove = function (t) {
        ...
        if (e)
            for (var r = this.config.nodes.length - 1; 0 <= r; r--)
                (this.config.nodes[r].pid != t && this.config.nodes[r].stpid != t) || ((this.config.nodes[r].pid = e.pid), (this.config.nodes[r].stpid = e.stpid)),
                ...
                for (var t = 0; t < c.length; t++)
                    for (var e in p[t]) {
                        ...
                        switch (e.toLowerCase()) {
                            case 'd':
                                var i = u((10 * y - 10) / f) * (p[t][e][0] - g[t][e][0]) + g[t][e][0],
                                    a = u((10 * y - 10) / f) * (p[t][e][1] - g[t][e][1]) + g[t][e][1];
                                c[t].setAttribute('d', c[t].getAttribute('d') + ' L' + i + ' ' + a);
                                break;
                            case 'r':
                                var n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e];
                            ...
                            case 'rotate3d':
                                if (p[t][e]) {
                                    var o = g[t][e],
                                        l = p[t][e],
                                        s = [0, 0, 0, 0];
                                    for (var h in o) s[h] = u((10 * y - 10) / f) * (l[h] - o[h]) + o[h];
                                    c[t].style.transform = 'rotate3d(' + s.toString() + 'deg)';
                                }
                                break;
                            case 'transform':
                                if (p[t][e]) {
                                    for (var h in ((o = g[t][e]), (l = p[t][e]), (s = [0, 0, 0, 0, 0, 0]), o)) s[h] = u((10 * y - 10) / f) * (l[h] - o[h]) + o[h];
                                    c[t].hasAttribute('transform') ? c[t].setAttribute('transform', 'matrix(' + s.toString() + ')') : (c[t].style.transform = 'matrix(' + s.toString() + ')');
                                }
                                break;
                            case 'viewbox':
                                if (p[t][e]) {
                                    for (var h in ((o = g[t][e]), (l = p[t][e]), (s = [0, 0, 0, 0]), o)) s[h] = u((10 * y - 10) / f) * (l[h] - o[h]) + o[h];
                            ...
                            case 'margin':
                                ...
                                break;
                            case 'scrolly':
                                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]), c[t].scrollTo(0, n);
                                break;
                            default:
                                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]), c[t] && c[t].style && (c[t].style[e] = n + r);
                        }
                    }
                m && m(), 1 + x < (y += 1) && (clearInterval(O), C && C(c));
            }, 10))
        );
    }),
    ...
    (OrgChart.prototype._attachEventHandlers = function (t) {
        ...
        this.config.enableTouch || e || /Mobi/i.test(navigator.userAgent) || /Android/i.test(navigator.userAgent)
    ...
    (OrgChart._intersects = function (t, e, r) {
        ...
        var l,
            ...
            p = e.s;
        return (
            0 != (l = (n - i) * (p - c) - (g - d) * (o - a)) && ((s = ((a - o) * (g - i) + (n - i) * (p - a)) / l), 0 < (h = ((p - c) * (g - i) + (d - g) * (p - a)) / l) && h < 1 && 0 < s && s < 1)
        );
    }),
                ...
                for (var r = this.wrapperElement.querySelectorAll('[data-field-name]'), i = 0; i < r.length; i++) {
                    ...
                    if (a) {
                        ...
                        if (a === OrgChart.TAGS) e.tags = n.split(',');
                            ...
                            o && e.tags
                                ? OrgChart._arrayContains(this.node.tags, 'assistant') || (OrgChart.STRING_TAGS ? (e.tags += ',assistant') : e.tags.push('assistant'))
                                : o && !e.tags
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r) {
        ...
        for (var g = d.w * (100 / r), p = d.h * (100 / r), f = o, u = l, C = []; f < s + o; ) {
            for (; u < h + l; ) {
                var m = [f, u, g, p];
                (m = m.join()), C.push({ vb: m, innerSize: d, size: c }), (u += p);
            }
            (f += g), (u = l);
        }
        return C;
    ...
    (OrgChart._importSetColumnNames = function (a, n) {
        if (-1 == a.indexOf('id') || -1 == a.indexOf('pid')) {
            ...
            for (var f = 0; f < a.length; f++) {
                (y = document.createElement('option')).setAttribute('value', a[f]);
                var u = document.createTextNode(a[f]);
                y.appendChild(u), g.appendChild(y);
            }
            ...
            for (f = 0; f < a.length; f++) {
                ...
                y.appendChild(u), O.appendChild(y);
            }
            var x = document.createElement('BUTTON');
            (x.innerHTML = 'Import'),
                (x.style.fontSize = '16px'),
                (x.style.color = 'rgb(122, 122, 122)'),
                (x.style.padding = '5px 20px'),
                (x.style.margin = '20px auto'),
            ...
            return (
                ...
                (document.onmouseup = function (t) {
                    (t = t || window.event),
                        o._dragging && ((o.style.left = o._originalLeft + t.clientX - o._mouseLeft + 'px'), (o.style.top = o._originalTop + t.clientY - o._mouseTop + 'px'), (o._dragging = !1));
                }),
                o
            );
        }
    ...
    (OrgChart.prototype._globalMouseDownHandler = function (t, e) {
        ...
        if (
            (-1 != e.type.indexOf('touch') &&
                (1 == e.touches.length ? (this._touch = { x: e.touches[0].clientX, y: e.touches[0].clientY }) : (this._touch = null),
    ...
    (OrgChart.prototype._nodeMouseDownHandler = function (O, t, i) {
        if (this.config.enableDragDrop) {
            ...
            var b = this,
                ...
                A = b.getScale(),
                L = O.cloneNode(!0);
            w.insertBefore(L, w.firstChild), (L.style.opacity = 0.7);
            var E = function (t, e) {
                    if (null != t) {
                        e.style.opacity = 1;
                        for (var r = b.getNode(x), i = OrgChart.getStParentNodes(r), a = 0; a < i.length; a++) {
                ...
                a = function (t) {
                    if (_) {
                        var e = OrgChart._getClientXY(t),
                            ...
                            a = { left: b.width() - (i.x + b.config.padding) < 0, right: i.x - b.config.padding < 0, down: b.height() - (i.y + b.config.padding) < 0, up: i.y - b.config.padding < 0 };
                        if (a.left || a.right || a.up || a.down) {
                            ...
                            if (
                                (b.stopMove(),
                                w.classList && (w.classList.add('cursor-grab'), w.classList.remove('cursor-move'), w.classList.remove('cursor-nodrop'), w.classList.remove('cursor-copy')),
                                E(x, v),
                                (v = x = null),
                            ...
                            if (null != x) {
                                v.style.opacity = 0.5;
                                for (var g = b.getNode(x), p = OrgChart.getStParentNodes(g), f = 0; f < p.length; f++) {
                                    var u = b.getNodeElement(p[f].id);
                                    u && (u.style.opacity = 0.1);
                                }
                                !b._canUpdateLink(y.id, x) && w.classList
                                    ? (w.classList.remove('cursor-grab'), w.classList.remove('cursor-move'), w.classList.remove('cursor-copy'), w.classList.add('cursor-nodrop'))
                                    : w.classList && (w.classList.remove('cursor-grab'), w.classList.remove('cursor-move'), w.classList.add('cursor-copy'), w.classList.remove('cursor-nodrop'));
                            }
                            var C = (e.x - _.x) / A,
                                m = (e.y - _.y) / A;
                            if (
                                ((k[4] = S + C),
                                (k[5] = I + m),
                                !O._dragEventFired && (Math.abs(e.x - _.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(e.y - _.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                            )
                                !1 === OrgChart.events.publish('drag', [b, c]) && M(), (O._dragEventFired = !0);
                            L.setAttribute('transform', 'matrix(' + k.toString() + ')');
                        }
                    }
                },
                M = function (t) {
                    if (
                        (b.stopMove(),
                        w.classList && (w.classList.remove('cursor-grab'), w.classList.remove('cursor-move'), w.classList.remove('cursor-nodrop'), w.classList.remove('cursor-copy')),
                        w.removeEventListener(i.move, a),
                        w.removeEventListener(i.up, M),
                        i.leave && w.removeEventListener(i.leave, M),
                        y.id == x || null == x)
                    )
                        return w.removeChild(L), void (b._gragStartedId = null);
                    var e = b.getNode(x);
                    if (!1 === OrgChart.events.publish('drop', [b, y.id, e.id])) return E(x, v), w.removeChild(L), void (b._gragStartedId = null);
                    if (b._canUpdateLink(y.id, x)) {
                        var r = b.get(y.id);
                        (r.pid = x), (r.stpid = null), b.updateNode(r, null, !0);
                    } else w.removeChild(L), E(x, v);
    ...
    (OrgChart.prototype._commonClickHandler = function (t, e, r) {
        ...
        r == OrgChart.action.edit && (this.editUI.show(i.id), this.ripple(i.id, e.clientX, e.clientY)),
            r == OrgChart.action.details && (this.editUI.show(i.id, !0), this.ripple(i.id, e.clientX, e.clientY));
    }),
...
(OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    (OrgChart.local._firstWalk = function (t, e, r, i, a) {
        if (!t.isPartner) {
            ...
            if (
                ...
                if (
                    (s.isAssistant && h.isAssistant && (d = s._prelim + (h._prelim - s._prelim) / 2 + OrgChart.local._leftMidPoint(s, a)),
                    (d -= OrgChart.local._mid(t, a)),
    ...
    (OrgChart.local._secondWalk = function (t, e, r, i, a, n, o) {
        if (e <= OrgChart.MAX_DEPTH && !t.isPartner) {
            ...
            switch (
                ((l = a[e]),
                (s = OrgChart.local._getNodeHeight(t, o)),
                (t.x = h),
                (t.y = d),
                t.hasPartners && OrgChart.local.nodeHasPartnersPosition(t, o, l),
                (t.isSplit || t.isAssistant || 2 == t.layout) && (t.y = d + l / 2 - s / 2),
                o.orientation)
            ) {
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
        ...
        if (!t.isPartner)
            for (var i = OrgChart.local._fChild(t), a = i.leftNeighbor, n = 1, o = OrgChart.MAX_DEPTH - e; null != i && null != a && n <= o; ) {
                ...
                if (0 < p) {
                    ...
                    if (null != f) for (var C = t, m = p / u; C != d; C = OrgChart.local._getLeftSibling(C)) (C._prelim += p), (C._modifier += p), (p -= m);
                }
                ...
                for (var f = 0; f < t.parent.children.length; f++) {
                    1 == (u = t.parent.children[f]).isPartner
                        ? ((o = t.parent.x + t.parent.w + t.parent.partnerSeparation),
                          g ? ((l = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - n) / 2), (c = u.h), (g = !1)) : ((l += c + e.partnerNodeSeparation), (c = u.h)),
                          (u.x = o),
                          (u.y = l))
                        : 2 == u.isPartner &&
                          ((s = t.parent.x - u.w - t.parent.partnerSeparation),
                          p ? ((h = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - a) / 2), (d = u.h), (p = !1)) : ((h += d + e.partnerNodeSeparation), (d = u.h)),
                          (u.x = s),
                          (u.y = h));
                }
                break;
                    ...
                    (u = t.parent.children[f]) &&
                        (1 == u.isPartner
                            ? ((l = t.parent.y + t.parent.h + t.parent.partnerSeparation),
                              g ? ((o = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - n) / 2), (c = u.w), (g = !1)) : ((o += c + e.partnerNodeSeparation), (c = u.w)),
                              (u.x = o),
                              (u.y = l))
                            : 2 == u.isPartner &&
                              ((h = t.parent.y - u.h - t.parent.partnerSeparation),
                              p ? ((s = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - a) / 2), (d = u.w), (p = !1)) : ((s += d + e.partnerNodeSeparation), (d = u.w)),
                              (u.x = s),
                              (u.y = h)));
                }
        }
    ...
    (OrgChart.searchUI.prototype._serverSearch = function (t) {
        for (
            ...
            if (n) {
                ...
                'function' == typeof n ? (h = n(this.obj, this.obj.getNode(s.id), d)) : d[n] && (h = d[n]),
                    h && (h = '<img style="padding: 2px 0px  2px 7px;width:32px;height:32px;" src="' + h + '" / >');
            }
            var c = '',
                g = '';
            this.obj.config.searchDisplayField == s.__searchField
                ? (c = s.__searchMarks)
                : this.obj.config.searchDisplayField
                ? ((c = s[this.obj.config.searchDisplayField]), OrgChart.isNullOrEmpty(c) && (c = ''), (g = s.__searchMarks))
                : (c = s.__searchMarks),
    ...
    (OrgChart.server.prototype.read = function (h, d, c, g, p, f, u, C) {
        ...
        OrgChart.state._get(this.config.state, d, c, function (t) {
            (m.state = t),
                (m.action = p),
                (m.actionParams = f),
                p == OrgChart.action.init && m.state ? ((m.viewBox = m.state.vb), (m.vbIsInitializedFromState = !0)) : ((m.viewBox = g), (m.vbIsInitializedFromState = !1));
            var r = m.maxX,
                i = m.maxY,
                a = m.minX,
                n = m.minY,
            ...
            if (h) {
                ...
                p != OrgChart.action.exporting && ((m.maxX = r), (m.maxY = i), (m.minX = a), (m.minY = n), (m.roots = l), (m.nodes = s), (m.visibleNodeIds = e.visibleNodeIds)),
                    (e.bordersByRootIdAndLevel = o),
                    (e.roots = l),
                    (e.adjustify = { x: 0, y: 0 }),
                    m.state && (e.adjustify = m.state.adjustify),
                    u(e);
            } else
                (m.oldNodes = s || null),
                    m._read(function (t) {
                        ...
                        (e.notif = t.limit),
                            ...
                            p != OrgChart.action.exporting &&
                                ((m.maxX = r), (m.maxY = i), (m.minX = a), (m.minY = n), (m.roots = l), (m.nodes = s), (m.visibleNodeIds = e.visibleNodeIds), (m.bordersByRootIdAndLevel = o)),
                            u(e);
                    }, C);
        });
    }),
        ...
        null == r && (r = OrgChart.local),
            r._setPositions(
                ...
                function (t) {
                    ...
                    for (var r = { minX: null, minY: null, maxX: null, maxY: null }, i = {}, a = 0; a < s.length; a++)
                        OrgChart.server._setMinMaxXYAdjustifyIterate(s[a], s[a], r, 0, i, e, o.config.orientation);
                    n({ minX: r.minX, minY: r.minY, maxX: r.maxX, maxY: r.maxY, bordersByRootIdAndLevel: i, nodes: l, roots: s, limit: t, adjustify: e });
                },
                l
            );
    }),
    ...
    (OrgChart.server._setCollpasedProperty = function (t, e, r, i, a, n, o) {
        null == t.collapsed && e.collapse && e.collapse.allChildren ? (t.collapsed = !0) : null == t.collapsed && (t.collapsed = !1),
            ...
            a == OrgChart.action.init && null != o
                ...
                : (a != OrgChart.action.centerNode && a != OrgChart.action.insert) || (-1 != i.indexOf(t.id) && (t.collapsed = !1));
    }),
    (OrgChart.server._initNode = function (t, e, r, i, a, n, o, l, s, h, d) {
        ...
        for (var g = 0; g < t.childrenIds.length; g++) {
            ...
            OrgChart.server._setCollpasedProperty(p, c, s, l, a, i, d),
                p.collapsed ||
                    ((p.parent = t),
                    (-1 == p.tags.indexOf('left-partner') && -1 == p.tags.indexOf('right-partner') && -1 == p.tags.indexOf('partner') && null == p.ppid) || (-1 == h.indexOf(t.id) && h.push(t.id)),
                    t.children.push(p));
        }
        if (
    ...
    (OrgChart.server._iterate = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f, u) {
        if (
            ...
            for (var C = [], m = 0, O = 0, y = 0; y < e.parent.children.length; y++) {
                var x = e.parent.children[y];
                -1 == x.tags.indexOf('partner') && -1 == x.tags.indexOf('assistant') && 0 == x.childrenIds.length
                    ? C.push(x.id)
                    : -1 != x.tags.indexOf('assistant')
                    ? m++
                    : -1 != x.tags.indexOf('partner') && O++;
            }
    ...
    (OrgChart.server._createNodes = function (a, t, e, r, i, n) {
        ...
        for (d = 0; d < s.length; d++) {
            ...
            if ((m || (f.stpid = null), O || (f.pid = null), m)) {
                var y = i ? i[m.id] : null;
                y && (m.min = y.min), m.stChildrenIds.push(f.id);
        ...
        if (e == OrgChart.action.init && a.expand && a.expand.nodes && null == n)
            for (d = 0; d < a.expand.nodes.length; d++) for (f = l[a.expand.nodes[d]]; f; ) v.push(f.id), null == f.pid && null != f.stpid ? ((f = l[f.stpid]).min = !1) : (f = l[f.pid]);
        ...
        for (d = 0; d < L.length; d++) {
            ...
            for (w = 0; w < f.children.length; w++) {
                (R = f.children[w]).isAssistant ||
                    (-1 != R.tags.indexOf('right-partner')
                        ...
                        : -1 == R.tags.indexOf('partner') || T % 2
                        ? -1 != R.tags.indexOf('partner') && T % 2
                            ? ((R.isPartner = 2), (R.children = []), N.push(R.id), T++)
                            : null != R.ppid
                            ? (P[R.ppid] || (P[R.ppid] = []), P[R.ppid].push(R.id))
                            : E.push(R.id)
                        : ((R.isPartner = 1), (R.children = []), M.push(R.id), T++));
            }
            f.children = [];
            ...
            for (w = N.length - 1; 0 <= w; w--) if (P[N[w]]) for (var j = 0; j < P[N[w]].length; j++) f.children.push(l[P[N[w]][j]]), B++, -1 == z.indexOf(N[w]) && z.push(N[w]);
            for (w = 0; w < E.length; w++) {
                R = l[E[w]];
                f.children.push(R);
            }
            for (w = 0; w < M.length; w++) if (P[M[w]]) for (j = 0; j < P[M[w]].length; j++) f.children.push(l[P[M[w]][j]]), F++, -1 == H.indexOf(M[w]) && H.push(M[w]);
            (f.partnerSeparation = Math.max(z.length, H.length) * a.partnerChildrenSplitSeparation + a.minPartnerSeparation),
                E.length || !B || F
                    ? E.length || B || !F
                        ? E.length || 1 != B || 1 != F
                            ? E.length || B || F
        ...
        for (d = 0; d < I.length; d++) {
            if ((et = t[(f = l[I[d]]).lcn ? f.lcn : 'base']).layout == OrgChart.normal || !A[f.pid])
                for (w = 0; w < f.subLevels; w++) {
                    ...
                    if ((OrgChart.server._initDinamicNode(U, f.lcn), (O = f.parent))) {
                        var D = O.children.indexOf(f);
                        -1 < D && (O.children.splice(D, 1), O.children.splice(D, 0, U)), U.children.push(f), (U.parent = O), (f.parent = U), (l[U.id] = U);
                    }
                }
        }
        for (var Y in S) {
            (O = l[Y]).hasAssistants = !0;
            U = new OrgChart.node(O.id + '_split_0', O.id, ['assistant'], 'split');
            OrgChart.server._initDinamicNode(U, O.lcn, !0), (l[U.id] = U);
            var X = [];
            for (w = O.children.length - 1; 0 <= w; w--) {
                (R = O.children[w]).isAssistant ? ((R.parent = null), O.children.splice(w, 1), X.splice(0, 0, R.id)) : R.isPartner || ((R.parent = U).children.unshift(R), O.children.splice(w, 1));
            }
            if (X.length % 2) {
            ...
            for (w = X.length - 1; 0 <= w; w--)
                if (w % 2 && w != X.length - 1) {
                    ...
                    OrgChart.server._initDinamicNode(G, O.lcn, !0), (l[G.id] = G), X.splice(w, 0, G.id), W++;
        ...
        if ($)
            for (var Y in A) {
                var et;
                if ((et = t[(O = l[Y]).lcn ? O.lcn : 'base']).layout == OrgChart.mixed || et.layout == OrgChart.tree || et.layout == OrgChart.treeRightOffset || et.layout == OrgChart.treeLeftOffset) {
                    var rt = { pnode: O, layout: et.layout, childrenIds: A[Y] };
                    if ((OrgChart.events.publish('layout', [rt]), rt.layout == OrgChart.mixed)) {
                        var it = rt.childrenIds;
                        for (d = it.length - 1; 0 <= d; d--) {
                            if (((O = (R = l[it[d]]).parent), (R.layout = OrgChart.mixed), 0 < d)) {
                                for (w = O.children.length - 1; 0 <= w; w--) R.id == O.children[w].id && O.children.splice(w, 1);
                                var at = l[it[d - 1]];
                        ...
                        U = new OrgChart.node(O.id + '_split_0', O.id, [], 'split');
                        OrgChart.server._initDinamicNode(U, O.lcn), ((l[U.id] = U).layout = OrgChart.tree);
                        var nt = [];
                        for (d = rt.childrenIds.length - 1; 0 <= d; d--) {
                            for (R = l[rt.childrenIds[d]], w = 0; w < O.children.length; w++) O.children[w].id == R.id && O.children.splice(w, 1);
                            if (
                                ((R.parent = null),
                        ...
                        for (w = 0; w < nt.length; w += 3) {
                            ...
                            0 != w && (K = l[nt[w - 3]]),
                                ...
                                Z && (0 != w && (K = l[nt[w - 2]]), (Z.parent = K).children.push(Z)),
                                Q && (0 != w && (K = l[nt[w - 1]]), (Q.parent = K).children.push(Q));
                        }
                    }
                }
            }
    ...
    (OrgChart.server.getAllFields = function (t) {
        ...
        for (r = 0; r < t.nodes.length; r++)
            for (var i in t.nodes[r])
                i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && i !== OrgChart.STPID && (t.nodeBinding[i] || OrgChart._arrayContains(e, i) || e.push(i));
        return e;
    }),
    ...
    (OrgChart.server._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f) {
        var u = h[0],
            ...
            y = a - o + 2 * i.padding,
            x = n - l + 2 * i.padding,
            v = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, y, x);
        if (
            ((m.top = l - i.padding),
            (m.left = o - i.padding),
            (m.bottom = n + i.padding - e / v),
            (m.right = a + i.padding - t / v),
            (m.maxX = a),
            (m.minX = o),
            (m.maxY = n),
            (m.minY = l),
            ...
            if (b - 2 * i.padding >= a - o)
                ...
                switch (((_ = u.x - b / 2 + OrgChart.server._getNodeWidth(u, i) / 2), i.orientation)) {
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
            ...
            if (w - 2 * i.padding >= n - l)
                ...
                switch (((k = -(w / 2 - (n - l) / 2)) > -i.padding && (k = -i.padding), i.orientation)) {
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
        ...
        return { animations: O, boundary: m, viewBox: s, visibleNodeIds: C, nodes: g, allFields: OrgChart.server.getAllFields(i) };
    }),
    (OrgChart.server._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
        if (OrgChart.server._isVisible(t, r, i, a)) {
            ...
            if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && 'expandCollapseToLevel' == n.method) {
                ...
                if ((null != (u = l[t.id]).x && null != u.y && (d = { x: u.x, y: u.y }), (f = e[n.id]) && f == t))
                    (c = t.parent) && c.id == n.id && (d = { x: f.x + f.w / 2 - t.w / 2, y: f.y + f.h / 2 - t.h / 2 });
            ...
            null != d &&
                null != d.x &&
                null != d.y &&
                ((d.x == t.x && d.y == t.y) || (h[0].push(t.id), h[1].push({ transform: [1, 0, 0, 1, d.x, d.y] }), h[2].push({ transform: [1, 0, 0, 1, t.x, t.y] })));
        }
    ...
    (OrgChart.templates.base = {
        ...
        exportMenuButton:
            '<div style="position:absolute;display:none;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer;" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
        img_0:
    ...
    (OrgChart.templates.ana = {
        ...
        nodeMenuButton:
            '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
        exportMenuButton:
            '<div style="position:absolute;right:{p}px;display:none;top:{p}px; width:40px;height:50px;cursor:pointer;" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
        img_0:
    ...
    (OrgChart.templates.isla.node =
        '<rect filter="url(#isla-shadow)" x="0" y="20" rx="5" ry="5" height="120" width="180" fill="#FFF" stroke-width="1" stroke="#039BE5" ></rect><rect x="25" y="75" rx="10" ry="10" height="20" width="130" fill="#039BE5" stroke-width="3" stroke="#039BE5"></rect><rect fill="#ffffff" stroke="#039BE5" stroke-width="1" x="70" y="0" rx="13" ry="13" width="40" height="40"></rect><circle stroke="#FFCA28" stroke-width="3" fill="none" cx="90" cy="12" r="8"></circle><path d="M75,34 C75,17 105,17 105,34" stroke="#FFCA28" stroke-width="3" fill="none"></path>'),
    ...
    (OrgChart.templates.isla.field_2 = '<text width="160" style="font-size: 13px;" fill="#039BE5" x="90" y="120" text-anchor="middle">{val}</text>'),
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            for (var g in (d.defs && (c = c.replace('{randId}', OrgChart.ui._defsIds[t.templateName])), null == o && (o = i.nodeBinding), o)) {
                ...
                if (e) {
                    var f = e[p];
                    if (('function' == typeof p && (f = p(h, t, e)), null != f && null != f && null != d[g]))
            ...
            var m = '';
            t.lcn && (m = 'lcn="' + t.lcn + '"');
            var O = OrgChart.nodeOpenTag.replace('{lcn}', m).replace('{id}', t.id).replace('{class}', C).replace('{sl}', t.sl).replace('{level}', t.level).replace('{x}', u.x).replace('{y}', u.y),
                y = OrgChart._getOpacity(r, t);
            ((O = O.replace('{opacity}', y)), null != i.nodeMenu && 'split' != t.templateName && l !== OrgChart.action.exporting) &&
                (c += d.nodeMenuButton
                    .replace('{id}', t.id)
                    .replace('{cw}', t.w / 2)
        ...
        link: function (t, e, r, i, a) {
            ...
            if (t.hasPartners) {
                ...
                for (var f = 0; f < t.children.length; f++) {
                    var u = null;
                    null != (C = t.children[f]).ppid && (u = a[C.ppid]),
                        u
                            ? ((p.ppnodes[C.id] = u),
                              p.ids.push(C.id),
                              1 == u.isPartner
                                  ? (-1 == p.rightIds.indexOf(u.id) && p.rightIds.push(u.id), (p.indexes[C.id] = p.rightIds.indexOf(u.id)), p.firstRight || (p.firstRight = C))
                                  : 2 == u.isPartner && (-1 == p.leftIds.indexOf(u.id) && p.leftIds.push(u.id), (p.indexes[C.id] = p.leftIds.indexOf(u.id)), (p.lastLeft = C)))
                            : C.isPartner || ((p.lastLeft = C), p.firstRight || (p.firstRight = C));
                }
                (p.maxSidePartnersWithChildren = Math.max(p.leftIds.length, p.rightIds.length)),
                    (d =
                        0 == p.maxSidePartnersWithChildren
                            ? e.config.minPartnerSeparation / 2
                            : e.config.minPartnerSeparation / 2 + p.partnerChildrenSplitSeparation * p.maxSidePartnersWithChildren + p.partnerChildrenSplitSeparation / 2);
            }
            for (f = 0; f < t.children.length; f++) {
                var C = t.children[f],
                    m = i[c][C.sl],
                    O = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 },
                    y = (l = OrgChart.t(C.templateName, C.min, r)).link;
                if (p && -1 != p.ids.indexOf(C.id))
                    switch (o.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                ...
                else if ((C.isAssistant || 2 == C.layout) && C.rightNeighbor && C.rightNeighbor.isSplit)
                    switch (o.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                ...
                else if ((C.isAssistant || 2 == C.layout) && C.leftNeighbor && C.leftNeighbor.isSplit)
                    switch (o.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                    ...
                    switch (o.orientation) {
                        ...
                        case OrgChart.orientation.top_left:
                            if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, l, d);
                                ...
                                var x = 1 == C.layout ? void 0 : m.minY - (m.minY - g.maxY) / 2;
                                O = OrgChart.ui._linkTopToBottom(t, C, l, h, x);
                            }
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, l, d);
                                ...
                                x = 1 == C.layout ? void 0 : m.maxY - (m.maxY - g.minY) / 2;
                                O = OrgChart.ui._linkBottomToTop(t, C, l, h, x);
                            }
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, l, d);
                                ...
                                x = 1 == C.layout ? void 0 : m.maxX - (m.maxX - g.minX) / 2;
                                O = OrgChart.ui._linkRightToLeft(t, C, l, h, x);
                            }
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, l, d);
                                ...
                                x = 1 == C.layout ? void 0 : m.minX - (m.minX - g.maxX) / 2;
                                O = OrgChart.ui._linkLeftToRight(t, C, l, h, x);
                            }
                    }
                if (-1 != y.indexOf('{rounded}'))
                    if ((O.xa == O.xb && O.xa == O.xc && O.xa == O.xd) || (O.ya == O.yb && O.ya == O.yc && O.ya == O.yd))
                        y = y.replace('{rounded}', 'M' + O.xa + ',' + O.ya + ' L' + O.xd + ',' + O.yd);
                    else {
                    ...
                    y =
                        -1 != y.indexOf('{edge}')
                            ? y.replace('{edge}', 'M' + O.xa + ',' + O.ya + ' ' + O.xb + ',' + O.yb + ' ' + O.xc + ',' + O.yc + ' L' + O.xd + ',' + O.yd)
                            : -1 != y.indexOf('{curve}')
                            ? y.replace('{curve}', 'M' + O.xa + ',' + O.ya + ' C' + O.xb + ',' + O.yb + ' ' + O.xc + ',' + O.yc + ' ' + O.xd + ',' + O.yd)
                            : y
                                  .replaceAll('{xa}', O.xa)
                                  .replaceAll('{ya}', O.ya)
                                  .replaceAll('{xb}', O.xb)
                ...
                var w = { node: t, cnode: C, p: O, html: y };
                ...
                '' != _ && ((_ = OrgChart.linkFieldsOpenTag.replace('{x}', O.x).replace('{y}', O.y).replace('{rotate}', 0) + _ + OrgChart.grCloseTag), s.push(_)), s.push(OrgChart.grCloseTag);
            }
            return s.join('');
        },
        ...
        _roundedEdge: function (t, e, r, i, a, n) {
            ...
            return (
                (t == r && t == a) || (e == i && e == n)
                    ? ((o = s = r), (l = h = i))
                    : (t != a && r == a && ((o = s = r), (l = i), e < n ? (h = i + OrgChart.LINK_ROUNDED_CORNERS) : n < e && (h = i - OrgChart.LINK_ROUNDED_CORNERS)),
                      t < a && r == a ? (r -= OrgChart.LINK_ROUNDED_CORNERS) : a < t && r == a && (r += OrgChart.LINK_ROUNDED_CORNERS),
                      e != n && i == n && ((o = r), (l = h = i), t < a ? (s = r + OrgChart.LINK_ROUNDED_CORNERS) : a < t && (s = r - OrgChart.LINK_ROUNDED_CORNERS)),
                      e < n && i == n ? (i -= OrgChart.LINK_ROUNDED_CORNERS) : n < e && i == n && (i += OrgChart.LINK_ROUNDED_CORNERS)),
                { x1: t, y1: e, x2: r, y2: i, x3: a, y3: n, qx1: o, qy1: l, qx2: s, qy2: h }
            );
        },
    ...
    (OrgChart.wrapText = function (t, e) {
        ...
        if ('multiline' == s) {
            ...
            p = 1;
            for (var O = 1, y = 1; y < f.length; y++) {
                var x = C.firstChild.data.length;
                if (((C.firstChild.data += ' ' + f[y]), C.getComputedTextLength() > l)) {
                    ...
                    (C = document.createElementNS(h, 'tspan')).setAttributeNS(null, 'x', a),
                        C.setAttributeNS(null, 'y', n + u * p),
                        C.setAttributeNS(null, 'text-anchor', o),
                        (m = document.createTextNode(f[y])),
                        C.appendChild(m),
                        d.appendChild(C),
                        p++;
                }
            ...
            if (null != d.innerHTML) (v = d.innerHTML), (d.innerHTML = '');
                ...
                var b = '';
                for (y = d.childNodes.length - 1; 0 <= y; y--) (b = XMLSerializer().serializeToString(d.childNodes[y]) + b), d.removeChild(d.childNodes[y]);
                v = b;
            }
            return v;
        }
    ...
    (OrgChart.prototype.zoom = function (t, e, r) {
        var i = this.getViewBox().slice(0),
            ...
            o = i[3];
        !0 === t
            ? ((i[2] = i[2] / OrgChart.SCALE_FACTOR), (i[3] = i[3] / OrgChart.SCALE_FACTOR))
            : !1 === t
            ? ((i[2] = i[2] * OrgChart.SCALE_FACTOR), (i[3] = i[3] * OrgChart.SCALE_FACTOR))
            : ((i[2] = i[2] / t), (i[3] = i[3] / t)),
            e || (e = [50, 50]),
    ...
    (OrgChart.pdfPrevUI._handler = function (t, e, r) {
        ...
        var y = t.element.querySelector('#bg-ppdf-content');
        OrgChart.anim(y, { opacity: 0 }, { opacity: 1 }, 300, OrgChart.anim.outSin);
    }),
        ...
        for (var r, i, a, n, o, l = '', s = 0; s < this.config.clinks.length; s++) {
            ...
            if (-1 != e.res.visibleNodeIds.indexOf(h.from) && -1 != e.res.visibleNodeIds.indexOf(h.to)) {
                ...
                switch (this.config.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        O <= y ? ((b = 1), (C.x = O + d.w / 10), (m.x = y - c.w / 10)) : ((b = -1), (C.x = O - d.w / 10), (m.x = y + c.w / 10)),
                            p == u ? ((b = 1), (C.y = p), (m.y = u)) : u < p ? ((C.y = p), (m.y = u + c.h)) : ((C.y = p + d.h), (m.y = u));
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (C.x = O <= y ? ((b = -1), O + d.w / 10) : ((b = 1), O - d.w / 10)),
                            (m.x = y + c.w / 10),
                            p == u ? ((b = -1), (C.y = p + d.h), (m.y = u + c.h)) : u < p ? ((C.y = p), (m.y = u + c.h)) : ((C.y = p + d.h), (m.y = u));
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (C.y = x <= v ? ((b = -1), x + d.h / 5) : ((b = 1), x - d.h / 5)),
                            (m.y = v + c.h / 5),
                            g == f ? ((b = -1), (C.x = g), (m.x = f)) : f < g ? ((C.x = g), (m.x = f + c.w)) : ((C.x = g + d.w), (m.x = f));
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (C.y = x <= v ? ((b = 1), x + d.h / 5) : ((b = -1), x - d.h / 5)),
                            (m.y = v + c.h / 5),
                            g == f ? ((b = 1), (C.x = g + d.w), (m.x = f + c.w)) : f < g ? ((C.x = g), (m.x = f + c.w)) : ((C.x = g + d.w), (m.x = f));
                }
                var w = I(C, m, b),
                    _ = h.template;
                _ || (_ = 'orange');
                ...
                l +=
                    ...
                    k.link
                        ...
                        .replaceAll('{c.x}', w.x)
                        .replaceAll('{c.y}', w.y);
                var S = ((r = C), (a = w), void 0, (n = ((i = m).x - r.x) / 2 + r.x), (o = (i.y - r.y) / 2 + r.y), { x: (n - a.x) / 2 + a.x, y: (o - a.y) / 2 + a.y });
    ...
    (OrgChart.prototype._slinks = function (S, I) {
        ...
        function t(t, e, r) {
            ...
            var d = { p: t.x + t.w / 2 + s.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + s.expandCollapseSize, s: E.minY + h };
            if (t.level == e.level)
                ...
                switch (l.orientation) {
                    ...
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (d.q = t.y + t.h), (d.s = E.maxY - h), i.push([d.p, d.q]), i.push([d.r, t.y + t.h + h / 3]);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (d.p = t.x), (d.q = t.y + t.h / 2 + s.expandCollapseSize), (d.r = E.minX - h), (d.s = t.y + t.h / 2 + s.expandCollapseSize), i.push([d.p, d.q]), i.push([t.x - h / 3, d.q]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (d.p = t.x + t.w),
            ...
            switch ((s = OrgChart.slinkTemplates[O]).labelPosition) {
                ...
                case 'middle':
                    ...
                    break;
                case 'end':
                    y = { x: i[i.length - 2][0], y: i[i.length - 2][1] };
            }
            ...
            if (((A += '<g c-link-from="{from}" c-link-to="{to}">'.replace('{from}', t.id).replace('{to}', e.id) + s.link.replaceAll('{d}', b)), M.label)) {
                var w = s.label.replace('{x}', y.x).replace('{y}', y.y).replace('{val}', M.label),
    ...
    OrgChart.events.on('redraw', function (t, e) {
        if (t.config.miniMap) {
            ...
            (drawnNodes = []),
                ...
                (function t(e, r) {
                    if (Array.isArray(r)) for (var i = 0; i < r.length; i++) t(e, r[i]);
                        ...
                        for (
                            a.fillStyle = OrgChart.miniMap.colors[3], a.beginPath(), a.lineWidth = '0.5', a.fillRect(r.x, r.y, r.w, r.h), a.strokeRect(r.x, r.y, r.w, r.h), i = 0;
                            i < r.stChildrenIds.length;
                            i++
                        )
                            h++,
                                checkedLevel.includes(r.id) ||
                                    (1 == h ? (a.fillStyle = OrgChart.miniMap.colors[0]) : 2 == h ? (a.fillStyle = OrgChart.miniMap.colors[1]) : 3 == h && (a.fillStyle = OrgChart.miniMap.colors[2]),
                                    a.beginPath(),
            ...
            var d = t.getViewBox()[0],
                ...
                g = t.getViewBox()[2],
                p = t.getViewBox()[3];
            (a.lineWidth = 0.5 / o), (a.strokeStyle = '#f57c00'), a.strokeRect(d, c, g, p), (a.globalAlpha = 0.4), (a.fillStyle = OrgChart.miniMap.selectorBackgroundColor), a.fillRect(d, c, g, p);
        }
    }),
    (OrgChart.miniMap = {}),
    ...
    (OrgChart._search.addNodeToResult = function (t, e, r, i, a, n) {
        ...
        null != i &&
            ...
            OrgChart.isNullOrEmpty(o.__searchMarks) && (o.__searchMarks = i.__searchMarks)),
            t.push(o);
    }),
    ...
    (OrgChart._search.searchIndexesOf = function (t, e) {
        ...
        if (!OrgChart.isNullOrEmpty(t))
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                if (!OrgChart.isNullOrEmpty(i)) for (var a = 0; -1 < (a = t.indexOf(i, a)); ) l.push({ length: i.length, start: a }), (a += i.length);
            }
        return (
            l.sort(function (t, e) {
        ...
        if (t.config.state) {
            ...
            !(function t(e) {
                if (Array.isArray(e)) for (var r = 0; r < e.length; r++) t(e[r]);
                    ...
                    for (
                        ('string' != typeof e.id || ('string' == typeof e.id && -1 == e.id.indexOf('split') && -1 == e.id.indexOf('mirror'))) && (i.push(e.id), 1 == e.min && a.push(e.id)), r = 0;
                ...
                OrgChart.state._put(t.width(), t.height(), t.response.viewBox, i, a, t.response.adjustify, t.config.state);
        }
    }),
    (OrgChart.state = {}),
    (OrgChart.state._buildStateNames = function (t) {
        return { paramScale: t + '-scale', paramX: t + '-x', paramY: t + '-y', paramExp: t + '-exp', paramMin: t + '-min', paramAdjustify: t + '-adjustify' };
    }),
        ...
        if (i) {
            ...
            if (i.readFromLocalStorage) {
                ...
                if (null != (r = OrgChart.localStorage.getItem(i.name)))
                    return (r = JSON.parse(r)), ((c = [])[0] = r.x), (c[1] = r.y), (c[2] = a / r.scale), (c[3] = n / r.scale), (r.vb = c), void o(r);
