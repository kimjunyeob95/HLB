...
$where .=" and A.mm_is_del='FALSE' and A.mm_super_admin='F' and A.mm_status='Y' ";
$query="SELECT COUNT(mmseq) as cnt FROM ess_member_base as A join ess_member_code as B on A.mmseq = B.mc_mmseq WHERE ".$where;
...
// echo('<pre>');print_r($enc->decrypt($list[2]['mm_name']));echo('</pre>');
	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
					<header class="page-header">
						<h2> <i class="fas fa fa-user-circle"></i> HASS 회원 </h2>
...
function detail_page(mc_coseq,mseq){
    location.href="/manage/hassmemberDetail.php?mccoseq="+mc_coseq+"&mmseq="+mseq+"&page="+page;
}
...
$('#btn-re-research').click(function(e){
	e.preventDefault();
	location.href="/manage/hassmember.php";
});
