...
union
(select distinct eat_division, '프로젝트' as 'info',eat_confirm_date as confirm_date,eat_applydate as applydate,eat_state as status from ess_activity_log where eat_mmseq = {$mmseq})
union
...
<div id="container" class="my-profile-card">
	...
	<div id="content" class="content-primary">
        <h2 class="content-title">정보 변경 상세(프로젝트) 수정 전</h2>
        ...
        <h2 class="content-title" style="margin-top:50px;">정보 변경 상세(프로젝트) 수정 후</h2>
		<div class="section-wrap">
            <!-- 기본 사항 -->
            <div id="tab-project2"class="tab-cont" >
                <div class="table-wrap" style="margin-top:20px;border-top:1px solid #d1d1d1;">
                    <table class="data-table left">
                        <caption>프로젝트</caption>
                        <colgroup>
