	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
            <header class="page-header">
                <h2> <i class="fas fa fa-user-circle"></i>  ESS 사원 관리</h2>
...
$('.btn-go-list').click(function(){
	location.href="/manage/member.php?page="+page+$subquery;
});
    ...
    $.ajax({
        ...
        success : function(result){
            if(result.code=='FALSE'){
                ...
                alert(result.msg);
                location.reload();
                // location.href="/manage/memberDetail.php?page="+page+$subquery;
            }
        }
    })
});
