...
// 이미지가 업로드될 폴더의 전체 경로입니다. // 여기서는 구현을 간단히 하기 위해서 웹 루트 안에 업로드합니다. 
$uploadfullPath = $_SERVER['DOCUMENT_ROOT'].'/data/ckupload/'; 
// 이미지가 웹에서 보여질때 사용되어질 기본 URL입니다. 
// 웹루트 부터의 절대 URL을 입력합니다. 
$imageBaseUrl = '/data/ckupload/'; 
...
// 브라우저의 언어코드가 넘어옵니다. (ko) // 필요하다면 파일명 엔코딩 등에 사용되어질 수 있습니다. 
...
if (isset($_FILES['upload'])) { 
	...
	$name =  'hlb_ck_data_'.date('YmdHis').".".$ext;
...
$url = $imageBaseUrl . $name ; } else { $message = '업로드된 파일이 없습니다.'; } 
