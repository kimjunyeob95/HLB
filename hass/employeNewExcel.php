...
<div id="container" class="ehr-main"> <!-- 180124 클래스 추가(닫기버튼 눌렀을 경우 aside-open 추가) -->
	...
	<div id="content" class="content-primary">
        <h2 class="content-title">신규 입사자 등록</h2>
		<div class="section-wrap">
            ...
            <div id="tab-information" class="tab-cont" >
                <div class="table-wrap" style="margin-top:20px;border-top:1px solid #d1d1d1; max-width:80%;">
                    <form id="human_excel" action="/@proc/hass/new_employexcelProc.php" method="post" enctype="multipart/form-data">
                        <table class="data-table left">
                            <caption>신규 입사자 등록</caption>
                            <colgroup>
                                <col style="width: 20%" />
                                <col style="width: *" />
                            </colgroup>
                            <tbody>
                                <tr>
                                    <th scope="col">신규 입사자 엑셀</th>
                                    <td><input type="file" id="file05" class="input-text" name="file05" title='신규 입사자 엑셀'></td>
                                </tr>
                                <tr>
                                    <th scope="col">신규 입사자 엑셀양식</th>
                                    <td><a href="/data/excelData/employe/신규입사자_엑셀양식.xlsx" target="_blank"><button type="button" data-type="다운로드" class="btn type10 medium">다운로드</button></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
                ...
                <div style="text-align:center;">
                    <div class="button-area large">
                        <button type="button" id="btn-salary" class="btn type01 large">신규 입사자 등록<span class="ico check01"></span></button>
                    </div>
                </div>
            </div>
            <!-- 신규 입사자 등록 -->
...
<script>
    ...
    $('#btn-salary').click(function(e){
        ...
        if(validate){
            if(confirm("정말 신규 입사자를 등록 하시겠습니까?")){
                $('#human_excel').submit();
            }
        }
    })
